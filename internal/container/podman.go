...
// PodmanManager implements ContainerManager for Podman
...
func (p *PodmanManager) GetEngine() ContainerEngine {
	return EnginePodman
}

// GetVersion returns the Podman version
func (p *PodmanManager) GetVersion() (string, error) {
...
// IsAvailable checks if Podman is available and working
...
func (p *PodmanManager) Run(ctx context.Context, options RunOptions) (string, error) {
	args := []string{"run"}
...
func (p *PodmanManager) Start(ctx context.Context, containerID string) error {
	cmd := exec.CommandContext(ctx, p.command, "start", containerID)
	return cmd.Run()
}

// Stop stops a running container
func (p *PodmanManager) Stop(ctx context.Context, containerID string, timeoutSeconds int) error {
	args := []string{"stop"}
	if timeoutSeconds > 0 {
...
func (p *PodmanManager) Remove(ctx context.Context, containerID string, force bool) error {
	args := []string{"rm"}
	if force {
		args = append(args, "-f")
	}
...
func (p *PodmanManager) Exec(ctx context.Context, containerID string, command []string, options ExecOptions) error {
	args := []string{"exec"}
...
func (p *PodmanManager) Logs(ctx context.Context, containerID string, options LogOptions) (io.ReadCloser, error) {
	args := []string{"logs"}
...
func (p *PodmanManager) Inspect(ctx context.Context, containerID string) (*ContainerInfo, error) {
	cmd := exec.CommandContext(ctx, p.command, "inspect", "--format", "{{json .}}", containerID)
	output, err := cmd.Output()
	if err != nil {
...
func (p *PodmanManager) List(ctx context.Context, options ListOptions) ([]ContainerInfo, error) {
...
// Pull pulls an image
func (p *PodmanManager) Pull(ctx context.Context, image string) error {
	cmd := exec.CommandContext(ctx, p.command, "pull", image)
	return cmd.Run()
}

// Build builds an image
func (p *PodmanManager) Build(ctx context.Context, options BuildOptions) (string, error) {
	args := []string{"build"}
...
func (p *PodmanManager) RemoveImage(ctx context.Context, imageID string, force bool) error {
	args := []string{"rmi"}
	if force {
		args = append(args, "-f")
	}
...
func (p *PodmanManager) ListImages(ctx context.Context) ([]ImageInfo, error) {
	cmd := exec.CommandContext(ctx, p.command, "images", "--format", "{{json .}}")
	output, err := cmd.Output()
	if err != nil {
...
func (p *PodmanManager) InspectImage(ctx context.Context, imageID string) (*ImageInfo, error) {
	cmd := exec.CommandContext(ctx, p.command, "inspect", "--format", "{{json .}}", imageID)
	output, err := cmd.Output()
	if err != nil {
...
func (p *PodmanManager) CreateNetwork(ctx context.Context, name string, options NetworkOptions) error {
...
func (p *PodmanManager) RemoveNetwork(ctx context.Context, name string) error {
	cmd := exec.CommandContext(ctx, p.command, "network", "rm", name)
	return cmd.Run()
}

// ListNetworks lists networks
func (p *PodmanManager) ListNetworks(ctx context.Context) ([]NetworkInfo, error) {
	cmd := exec.CommandContext(ctx, p.command, "network", "ls", "--format", "{{json .}}")
	output, err := cmd.Output()
	if err != nil {
...
func (p *PodmanManager) CreateVolume(ctx context.Context, name string, options VolumeOptions) error {
...
func (p *PodmanManager) RemoveVolume(ctx context.Context, name string, force bool) error {
...
func (p *PodmanManager) ListVolumes(ctx context.Context) ([]VolumeInfo, error) {
	cmd := exec.CommandContext(ctx, p.command, "volume", "ls", "--format", "{{json .}}")
	output, err := cmd.Output()
	if err != nil {
